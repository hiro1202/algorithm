...
/**
 * バケットソートアルゴリズムのテストクラス
 */
@DisplayName("バケットソート")
class BucketSortTest {

    private lateinit var bucketSort: BucketSort
    ...
    inner class NormalCases {
        ...
        fun sortBasicArray() {
            ...
            // When
            val result = bucketSort.sort(input)
        ...
        @Test
        @DisplayName("全て同じ値の配列をソートできること")
        fun sortArrayWithAllSameValues() {
            // Given
            ...
            // Then
            assertThat(result).isEqualTo(intArrayOf(5, 5, 5, 5))
        }
    }
}
